...
11) Crie um loop que percorre o array de pessoas e verifica se a idade de cada
   pessoa é maior ou igual a 18 anos. Se for, imprima uma mensagem dizendo
   que a pessoa é maior de idade; caso contrário, imprima uma mensagem
   dizendo que a pessoa é menor de idade.
