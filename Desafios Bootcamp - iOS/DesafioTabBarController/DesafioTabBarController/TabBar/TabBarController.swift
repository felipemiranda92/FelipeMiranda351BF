...
//  DesafioTabBarController
//
//  Created by Felipe Miranda Santos on 03/10/23.
//
...
class TabBarController: UITabBarController {
    ...
    func addControllers() {
        ...
        let lastVC: UINavigationController = {
            ...
            let nav = UINavigationController(rootViewController: vc ?? UIViewController())
            nav.tabBarItem = UITabBarItem(title: "Tela 04", image: UIImage(systemName: "trash.slash.circle.fill"), tag: 2)
            return nav
        }()
        
        viewControllers = [firstVC, secondVC, thirdVC, lastVC]
    }
